...
public class MedicamentSearch {
    ...
    public MedicamentSearch(String nomTitulaire, String numeroAMM, String formePharmaceutique, String typeProcedure, String conditionDelivrance, LocalDate debutDate, LocalDate finDate, String substanceActive1, String substanceActive2, List<String> especeDestinationList) {
